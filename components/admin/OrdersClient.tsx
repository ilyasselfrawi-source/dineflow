...
export default function OrdersClient({ initialOrders, settings, tables, initialFilters }: Props) {
    ...
    <div className="p-6 max-w-5xl mx-auto">
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-stone-500 text-sm mt-0.5">{orders.length} result{orders.length !== 1 ? "s" : ""}</p>
        </div>
                  ...
                  return (
                    <tr key={order.id} className="hover:bg-stone-50 transition-colors">
                      ...
                      <td className="px-4 py-3.5">
                        <span className="text-sm font-medium text-stone-700">{order.table.number}</span>
                      </td>
                      <td className="px-4 py-3.5">
                      ...
                      <td className="px-4 py-3.5">
                        <span className="font-semibold text-stone-900 text-sm">{formatCurrency(order.total, sym)}</span>
                      </td>
